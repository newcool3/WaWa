...
namespace ReserverRideVar01.Service
{
    public class MailService
    {
        ...
        {
            string userName = "littleabroad34";
            string password = "34Littleabroad34";
